...
readonly class OperationBaseItem
{
    public function __construct(
        ...
        public ?OperationLocation $currentLocation,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            currentLocation: isset($data['currentLocation']) ? OperationLocation::fromArray($data['currentLocation']) : null,
...
readonly class OperationCreateItem extends OperationBaseItem
{
    public function __construct(
        ...
        OperationLocation $currentLocation,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            currentLocation: $base->currentLocation ?? throw new \InvalidArgumentException('currentLocation is required for create operation'),
            transitTo: $base->transitTo,
            availability: $base->availability,
            sku: $base->sku ?? throw new \InvalidArgumentException('sku is required for create operation'),
            packageQuantity: $base->packageQuantity ?? throw new \InvalidArgumentException('packageQuantity is required for create operation'),
...
readonly class OperationQuery
{
    public function __construct(
        ...
        public ?OperationQueryLocation $currentLocation,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            currentLocation: isset($data['currentLocation']) ? OperationQueryLocation::fromArray($data['currentLocation']) : null,
